 ...
 */
public class BouyantPlumeRiseFunc implements UnivariateDifferentiableFunction
{
    ...
    public BouyantPlumeRiseFunc(double buoyancyFlux,
                                double s,
    ...
    public DerivativeStructure value(DerivativeStructure t) throws DimensionMismatchException {
        return t.subtract(this.physicalStackHeight).pow(3).multiply(this.s).pow(-1)
    ...
    public double value(double x) {
        return ((17.576 * this.buoyancyFlux) / (this.s * Math.pow(x - this.physicalStackHeight, 3))) -
